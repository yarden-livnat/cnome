...
import edu.utah.sci.cyclist.model.proxy.SimulationProxy;
...
//		setStartX(from.getTranslateX());
//		setStartY(from.getTranslateY());
//		setEndX(to.getTranslateX());
//		setEndY(to.getTranslateY());
	}
//	
//	public void update(Node node, double x, double y) {
//		if (node == _from) {
//			setStartX(x);
//			setStartY(y);
//		} else {
