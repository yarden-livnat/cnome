...
public class SimulationTablesBuilder {
	 ...
	 */
	public static void updateSqliteSimTables(Connection conn, CyclistDatasource ds){
		...
		try {	
			...
			} else if(os.indexOf(DARWIN_OS)>=0){
				if(osArch.indexOf(ARCHITECTURE_64)>=0){
	 ...
	 * @throws Exception
	 */
	public static void createFacilitiesTable(Connection conn, CyclistDatasource ds) throws Exception{
		Statement stmt;
		try {
