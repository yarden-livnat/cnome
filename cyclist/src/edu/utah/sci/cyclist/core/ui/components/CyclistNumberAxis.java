 ...
 * @since JavaFX 2.0
 */
public class CyclistNumberAxis extends ValueAxis<Number> {
    ...
    private DoubleProperty tickUnit = new StyleableDoubleProperty(5) {
        ...
        @Override
        public CssMetaData<CyclistNumberAxis,Number> getCssMetaData() {
    ...
    /**
     * Create a auto-ranging NumAxis2
     */
    public CyclistNumberAxis() {}

    /**
     * Create a non-auto-ranging NumAxis2 with the given upper bound, lower bound and tick unit
     *
     ...
     */
    public CyclistNumberAxis(double lowerBound, double upperBound, double tickUnit) {
     ...
     * @param tickUnit The tick unit, ie space between tickmarks
     */
    public CyclistNumberAxis(String axisLabel, double lowerBound, double upperBound, double tickUnit) {
        super(lowerBound, upperBound);
        setTickUnit(tickUnit);
        setLabel(axisLabel);
    }
    ...
    @Override protected void setRange(Object range, boolean animate) {
        ...
        setTickUnit(tickUnit);
        // Yarden
        // HACK: Fix until a way around the private ValueAxiw<T>.scalePropertyImpl() can be found
//        if(animate) {
...
//        }
        ...
        if (tickUnit <= 0 || lowerBound == upperBound) {
            ...
            for (double major = lowerBound; major <= upperBound; major += tickUnit)  {
                ...
                if(tickValues.size()>2000) {
                    ...
                    System.err.println("Warning we tried to create more than 2000 major tick marks on a NumAxis2. " +
            ...
            for (double major = lowerBound; major < upperBound; major += tickUnit)  {
                for (double minor=major+minorUnit; minor < (major+tickUnit); minor += minorUnit) {
                    ...
                    if(minorTickMarks.size()>10000) {
                        // This is a ridiculous amount of major tick marks, something has probably gone wrong
                        System.err.println("Warning we tried to create more than 10000 minor tick marks on a NumAxis2. " +
    ...
    private static class StyleableProperties {
        private static final CssMetaData<CyclistNumberAxis,Number> TICK_UNIT =
            new CssMetaData<CyclistNumberAxis,Number>("-fx-tick-unit",
                SizeConverter.getInstance(), 5.0) {

            @Override
            public boolean isSettable(CyclistNumberAxis n) {
                return n.tickUnit == null || !n.tickUnit.isBound();
            }

            @Override
            public StyleableProperty<Number> getStyleableProperty(CyclistNumberAxis n) {
    ...
    /**
     * Default number formatter for NumAxis2, this stays in sync with auto-ranging and formats values appropriately.
    ...
    public static class DefaultFormatter extends StringConverter<Number> {
        ...
        /**
         * Construct a DefaultFormatter for the given NumAxis2
         *
         * @param axis The axis to format tick marks for
         */
        public DefaultFormatter(final CyclistNumberAxis axis) {
        ...
        /**
         * Construct a DefaultFormatter for the given NumAxis2 with a prefix and/or suffix.
         *
         * @param axis The axis to format tick marks for
         ...
         */
        public DefaultFormatter(CyclistNumberAxis axis, String prefix, String suffix) {
            this(axis);
            this.prefix = prefix;
            this.suffix = suffix;
        }
